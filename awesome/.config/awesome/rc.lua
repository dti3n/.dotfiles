...
globalkeys = gears.table.join(
    ...
    -- Volume control
    awful.key({}, "XF86AudioRaiseVolume", require("dtien.volume").inc),
    awful.key({}, "XF86AudioLowerVolume", require("dtien.volume").dec),
    awful.key({}, "XF86AudioMute", require("dtien.volume").toggle),

    -- Change keyboard language
    awful.key({ modkey }, "z", function ()
        awful.util.spawn_with_shell("~/.local/bin/changelanguage")
    end),
...
awful.rules.rules = {
    ...
    { rule = { class = "thunderbird" },
        properties = { tag = "9", floating = false } },
